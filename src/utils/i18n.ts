export const translations = {
  es: {
    ...
    "home.description":
      "Diccionario completo de chapinismos, palabras guatemaltecas, modismos y expresiones típicas de Guatemala con definiciones, ejemplos y uso correcto.",
    "home.keywords":
      "diccionario chapín, chapinismos, guatemaltequismos, palabras chapinas, jerga guatemalteca, modismos Guatemala",
    "home.subtitle":
    ...
    "home.dailyWord.learnMore": "Ver definición",
    "home.dailyWord.synonyms": "Sinónimos",
    ...
    "word.type": "chapinismo",
    "word.more_info": "Más información",
    "word.slang.label": "chapinismo",
  ...
  en: {
    ...
    "home.description":
      "Complete dictionary of Guatemalan slang, words, idioms and typical expressions from Guatemala with definitions, examples and correct usage.",
    "home.keywords":
    ...
    "home.dailyWord.learnMore": "See definition",
    "home.dailyWord.synonyms": "Synonyms",
    ...
    "word.type": "Guatemalan Slang Dictionary",
    "word.more_info": "More information",
    "word.slang.label": "guatemalan slang",
